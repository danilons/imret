...
if __name__ == "__main__":
    ...
    caffe.set_mode_cpu()
    net = caffe.Net('data/scene/indoor/deploy.prototxt',
    ...
    with open("data/scene/indoor/palette.txt", "r") as fp:
    ...
    for nn, fname in enumerate(fnames):
        ...
        skimage.io.imsave(os.path.join('data/scene/output-seg/indoor/', name), paletted)
